function [tree,lastnode]=maketree(level,oplist,oparity,exactlevel,depthnodes,inicparamvalue,lastnode)
...
%%
%Add parameter value to tree struct
if (strcmp(tree.op,   '1')) ||...
   (strcmp(tree.op(1),'X')) ||...
   (strcmp(tree.op,   'cos')) ||...
   (strcmp(tree.op,   'sin')) ||...
   ...
   (strcmp(tree.op,   'tanh')) ||...
   (strcmp(tree.op,   'exp')) ||...
   (strcmp(tree.op,   'mylog')) ||...
   (strcmp(tree.op,   'mysqrt')) ||...
   (strcmp(tree.op,   'mysquared')) ||...
   (strcmp(tree.op,   'mycubic')) ||...
   (strcmp(tree.op,   'mynegative'))
    if inicparamvalue == 1
        tree.param=1;
    else
        tree.param=rand(1,1);
...
for i=1:a
   ...
   [t,lastnode]=maketree(newlevel,oplist,oparity,exactlevel,depthnodes,inicparamvalue,thisnode);
   tree.kids{i}=t;
   thisnode=lastnode+1;
end
