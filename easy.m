function accept=easy(currentmean,state,params)
%EASY    Decides whether to accept a GPLAB individual into the population.
%   EASY(MEAN,STATE,PARAMS) returns true (acceptance) if the acceptance
...
%   so the name is EASY (compare with normal.m).
%   
%   Input arguments:
