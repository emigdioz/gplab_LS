function [pop,lastid]=rampedinit(n,lastid,maxlevel,oplist,oparity,depthnodes,inicparamvalue);
...
for m=1:nlevels;
   ...
   if ncreated<n
      ...
      if ntocreate>0
	      [partialpop,lastid]=fullinit(ntocreate,lastid,thislevel,oplist,oparity,depthnodes,inicparamvalue);
   ...
   if ncreated<n
      ...
      if ntocreate>0
	      [partialpop,lastid]=growinit(ntocreate,lastid,thislevel,oplist,oparity,depthnodes,inicparamvalue);
         pop(ncreated+1:ncreated+ntocreate)=partialpop;
      end
      ncreated=ncreated+ntocreate;
   end
...
if ncreated<n
   ...
   [partialpop,lastid]=growinit(ntocreate,lastid,maxlevel,oplist,oparity,depthnodes,inicparamvalue);
   pop(ncreated+1:ncreated+ntocreate)=partialpop;
end
