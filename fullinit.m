function [pop,lastid]=fullinit(n,lastid,maxlevel,oplist,oparity,depthnodes,inicparamvalue);
...
for i=1:n
   ntry=1;
   while ntry<=20
   	[pop(i),tmplastid]=newind(lastid,maxlevel,oplist,oparity,1,depthnodes,inicparamvalue);
