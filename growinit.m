function [pop,lastid]=growinit(n,lastid,maxlevel,oplist,oparity,depthnodes,inicparamvalue);
...
for i=1:n
   ntry=1;
   while ntry<=20
   	[pop(i),tmplastid]=newind(lastid,maxlevel,oplist,oparity,0,depthnodes,inicparamvalue);
