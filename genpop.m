...
[pop,state.lastid]=initpop(n,state.lastid,params.inicmaxlevel,state.functions,state.arity,params.initpoptype,params.depthnodes,params.inicparamvalue);
%Parameter 'inicparamvalue' added for LS use.
